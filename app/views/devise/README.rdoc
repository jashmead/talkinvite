...
1. registrations/edit -- update account
1. passwords/new
1. passwords/edit
1. mailer/reset
...
Fixes: 
1. fix sign_up, sign_in, sign_out links to work with the above
1. make sure that the parameters for sign_up, sign_in, account_update are set, in application_controller, in configure_permitted_parameters 
