...
1. roll theme that is more appropriate, add in 'f', 'g', 'h' swatches at some point -- done
1. the search_field is from ruby-on-rails -- compare to equivalent for jQuery Mobile & resolve differences
1. verify that all forms have been given a valid @record before they get started; log errors if they haven't been
