...
1. Notifications -- includes Tweets, links to talk & to people (sender), includes modalities (array?), start with core, expand
1. Venues -- links to creator, has location type (as two fields), venue_type, name, description
...
1. Ads -- have no idea what to put here!  wait till we get here
