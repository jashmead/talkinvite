...
Connections is most promising but might find it easier to add a source_id field to talks, then index it, with talk_type would have all the functionality we have in mind currently, i.e. clone & also repeating
