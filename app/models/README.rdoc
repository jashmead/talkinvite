...
Core tables (in order of importance):
1. talks
1. people
1. locations
...
1.  peer2peer style -- a is following b
* how tutorial does it
* more informal, better suited to problem here
* can add "virtual" flag to make it act as a group, if that becomes useful, ok, go peer2peer
1.  group style -- both a and b are members of same group, more static
...
1.  add in not-null for fk fields 
1.  add in not-null generally for fields
1.  add in defaults, limits as indicated
