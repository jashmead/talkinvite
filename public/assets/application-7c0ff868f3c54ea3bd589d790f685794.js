...
/* 
  -- "function" is a reserved word in coffeescript, so moved this script from talks.js.coffee to talks-date.js
  
  -- if we use the $(function(){} wrapper for this, we break all the javascript on the page!
  
  -- try adding datepicker in the mobileinit.js?
*/
// $('#talk_talk_date').datepicker();
/*
function talks_control_init() {
...
/*
(function() {
  var talks_control_init;

  talks_control_init = function() {
    return 1;
  };
