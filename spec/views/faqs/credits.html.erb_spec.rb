...
describe "faqs/credits" do
  ...
  ## recall that the credit index form shows *only* the questions, so look only for them!
...
# do not know why the next test is failing:  direct inspection of the screen shows ok
  ...
  it "goes to the associated credit on click" do
    pending "goes to the associated credit on click"
  end
