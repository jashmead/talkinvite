  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved service as @service" do
        ...
        post :create, {:service => { "person_id" => "invalid value" }}, valid_session
        assigns(:service).should be_a_new(Service)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested service" do
        ...
        Service.any_instance.should_receive(:update).with({ "person_id" => "1" })
        put :update, {:id => service.to_param, :service => { "person_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the service as @service" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Service.any_instance.stub(:save).and_return(false)
        put :update, {:id => service.to_param, :service => { "person_id" => "invalid value" }}, valid_session
        assigns(:service).should eq(service)
      end
