...
describe AdsController do
  ...
  let(:valid_attributes) { { "name" => "ad summary", "source" => "ad whence", 
    "content" => "ad content", "strategy" => "ad strategy" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ad as @ad" do
        ...
        post :create, {:ad => { "name" => "invalid value" }}, valid_session
        assigns(:ad).should be_a_new(Ad)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ad" do
        ...
        Ad.any_instance.should_receive(:update).with({ "name" => "" })
        put :update, {:id => ad.to_param, :ad => { "name" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ad as @ad" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ad.any_instance.stub(:save).and_return(false)
        put :update, {:id => ad.to_param, :ad => { "name" => "invalid value" }}, valid_session
        assigns(:ad).should eq(ad)
      end
