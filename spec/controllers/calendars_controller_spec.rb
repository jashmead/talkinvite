...
describe CalendarsController do
  ...
  let(:valid_attributes) { { "talk_id" => talk.id, "person_id" => person.id, 
    "name" => "MyCalendar", "description" => "blitheration & nonsense", "scale" => "day" } }
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created calendar" do
        post :create, {:calendar => valid_attributes}, { return_to: calendars_path }
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "redirects to the calendar" do
        calendar = Calendar.create! valid_attributes
        put :update, {:id => calendar.to_param, :calendar => valid_attributes}, { return_to: calendars_path }
        response.should redirect_to(calendars_path)
      end
    end
