...
describe CalendarsController do
  ...
  let(:valid_attributes) { { "name" => "MyCalendar", "description" => "MyChronology", 
    "chronometry" => "{}", "settings" => "{}", "history" => "{}" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested calendar" do
        ...
        Calendar.any_instance.should_receive(:update).with({ "name" => "MyString" })
