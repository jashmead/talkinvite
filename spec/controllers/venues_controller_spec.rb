  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved venue as @venue" do
        ...
        post :create, {:venue => { "person_id" => "invalid value" }}, valid_session
        assigns(:venue).should be_a_new(Venue)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested venue" do
        ...
        Venue.any_instance.should_receive(:update).with({ "person_id" => "1" })
        put :update, {:id => venue.to_param, :venue => { "person_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the venue as @venue" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Venue.any_instance.stub(:save).and_return(false)
        put :update, {:id => venue.to_param, :venue => { "person_id" => "invalid value" }}, valid_session
        assigns(:venue).should eq(venue)
      end
