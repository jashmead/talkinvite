  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved member as @member" do
        ...
        post :create, {:member => { "talk_id" => "invalid value" }}, valid_session
        assigns(:member).should be_a_new(Member)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested member" do
        ...
        Member.any_instance.should_receive(:update).with({ "talk_id" => "1" })
        put :update, {:id => member.to_param, :member => { "talk_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the member as @member" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Member.any_instance.stub(:save).and_return(false)
        put :update, {:id => member.to_param, :member => { "talk_id" => "invalid value" }}, valid_session
        assigns(:member).should eq(member)
      end
