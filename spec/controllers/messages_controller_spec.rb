...
## basically the use of messages as a link table appears to have completely confused the scaffold generator
## will need to build up various tests by hand:
##  both ends of the user exist, the talks exist, the destroy of either talk or either endpoint kills the messages as well, ...
=begin
describe MessagesController do
  ...
  let(:valid_attributes) { { "from_person_id" => "1", "to_person_id" => "2" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved message as @message" do
        ...
        post :create, {:message => { "from_person_id" => "invalid value" }}, valid_session
        assigns(:message).should be_a_new(Message)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested message" do
        ...
        Message.any_instance.should_receive(:update).with({ "from_person_id" => "1" })
        put :update, {:id => message.to_param, :message => { "from_person_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the message as @message" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Message.any_instance.stub(:save).and_return(false)
        put :update, {:id => message.to_param, :message => { "from_person_id" => "invalid value" }}, valid_session
        assigns(:message).should eq(message)
      end
