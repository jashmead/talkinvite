...
describe AttachmentsController do
  ...
  let(:valid_attributes) { { "name" => "Baby's first attachment", "attachment_type" => "image", 
    "attachable_type" => "talks", "attachable_id" => talk.id } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attachment" do
        ...
        Attachment.any_instance.should_receive(:update).with({ "name" => "MyString" })
