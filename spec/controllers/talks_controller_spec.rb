  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested talk" do
        ...
        Talk.any_instance.should_receive(:update).with({ "summary" => "MyString" })
        put :update, {:id => talk.to_param, :talk => { "summary" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the talk as @talk" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Talk.any_instance.stub(:save).and_return(false)
        put :update, {:id => talk.to_param, :talk => { "summary" => "invalid value" }}, valid_session
        assigns(:talk).should eq(talk)
      end
